<div class="politics_3" style="max-height: 400px; overflow-y: scroll; overflow-x: hidden;">
    <h4>
        <a class="heading_tag" href="{{ route('list') }}/?q={{$keywordsXml['dynamicview24']}}">
            <span>{{ !empty($keywordsXml) ? $keywordsXml['dynamicview24'] : '' }}</span>
        </a>
        <div class="input-group" style="display: none;">
            <input type="hidden" class="hdnKeywordName" value="dynamicview24" />
        <input type="text" value="{{ !empty($keywordsXml) ? $keywordsXml['dynamicview24'] : '' }}" class="form-control txtKeywordEdit" name="txtKeywordEdit" placeholder="" required/>
