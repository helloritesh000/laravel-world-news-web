<h5>
    <a class="heading_tag" href="{{ route('list') }}/?q={{$keywordsXml['dynamicview18']}}">
        <span>{{ !empty($keywordsXml) ? $keywordsXml['dynamicview18'] : '' }}</span>
    </a>
    <div class="input-group" style="display: none;">
        <input type="hidden" class="hdnKeywordName" value="dynamicview18" />
    <input type="text" value="{{ !empty($keywordsXml) ? $keywordsXml['dynamicview18'] : '' }}" class="form-control txtKeywordEdit" name="txtKeywordEdit" placeholder="" required/>
