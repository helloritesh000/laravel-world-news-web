<h5>
    <a class="heading_tag" href="{{ route('list') }}/?q={{$keywordsXml['dynamicview12']}}">
        <span>{{ !empty($keywordsXml) ? $keywordsXml['dynamicview12'] : '' }}</span>
    </a>
    <div class="input-group" style="display: none;">
        <input type="hidden" class="hdnKeywordName" value="dynamicview12" />
    <input type="text" value="{{ !empty($keywordsXml) ? $keywordsXml['dynamicview12'] : '' }}" class="form-control txtKeywordEdit" name="txtKeywordEdit" placeholder="" required/>
...
<a href="#"><img src="{{ asset('img/48.jpg') }}" width="100%"></a>
