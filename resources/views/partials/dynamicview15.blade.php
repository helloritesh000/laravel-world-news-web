<h5>
    <a class="heading_tag" href="{{ route('list') }}/?q={{$keywordsXml['dynamicview15']}}">
        <span>{{ !empty($keywordsXml) ? $keywordsXml['dynamicview15'] : '' }}</span>
    </a>
    <div class="input-group" style="display: none;">
        <input type="hidden" class="hdnKeywordName" value="dynamicview15" />
    <input type="text" value="{{ !empty($keywordsXml) ? $keywordsXml['dynamicview15'] : '' }}" class="form-control txtKeywordEdit" name="txtKeywordEdit" placeholder="" required/>
