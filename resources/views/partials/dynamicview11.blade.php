<h5>
    <a class="heading_tag" href="{{ route('list') }}/?q={{$keywordsXml['dynamicview11']}}">
        <span>{{ !empty($keywordsXml) ? $keywordsXml['dynamicview11'] : '' }}</span>
    </a>
    <div class="input-group" style="display: none;">
        <input type="hidden" class="hdnKeywordName" value="dynamicview11" />
    <input type="text" value="{{ !empty($keywordsXml) ? $keywordsXml['dynamicview11'] : '' }}" class="form-control txtKeywordEdit" name="txtKeywordEdit" placeholder="" required/>
...
<a href="#"><img src="{{ asset('img/47.jpg') }}" width="100%"></a>
