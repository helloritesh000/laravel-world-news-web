<h5>
    <a class="heading_tag" href="{{ route('list') }}/?q={{$keywordsXml['dynamicview3']}}">
        <span>{{ !empty($keywordsXml) ? $keywordsXml['dynamicview3'] : '' }}</span>
    </a>
    <div class="input-group" style="display: none;">
        <input type="hidden" class="hdnKeywordName" value="dynamicview3" />
    <input type="text" value="{{ !empty($keywordsXml) ? $keywordsXml['dynamicview3'] : '' }}" class="form-control txtKeywordEdit" name="txtKeywordEdit" placeholder="" required/>
