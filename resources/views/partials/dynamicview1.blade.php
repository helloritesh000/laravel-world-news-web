...
<h5>
    <a class="heading_tag" href="{{ route('list') }}/?q={{$keywordsXml['dynamicview1']}}">
        <span>{{ !empty($keywordsXml) ? $keywordsXml['dynamicview1'] : '' }}</span>
    </a>
    <div class="input-group" style="display: none;">
        <input type="hidden" class="hdnKeywordName" value="dynamicview1" />
    <input type="text" value="{{ !empty($keywordsXml) ? $keywordsXml['dynamicview1'] : '' }}" class="form-control txtKeywordEdit" name="txtKeywordEdit" placeholder="" required/>
...
<a href="#"><img src="{{ asset('img/12.jpg') }}" width="100%"></a>
@if(!empty($newsList))
