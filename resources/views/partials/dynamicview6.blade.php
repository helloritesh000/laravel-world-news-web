<h5>
    <a class="heading_tag" href="{{ route('list') }}/?q={{$keywordsXml['dynamicview6']}}">
        <span>{{ !empty($keywordsXml) ? $keywordsXml['dynamicview6'] : '' }}</span>
    </a>
    <div class="input-group" style="display: none;">
        <input type="hidden" class="hdnKeywordName" value="dynamicview6" />
    <input type="text" value="{{ !empty($keywordsXml) ? $keywordsXml['dynamicview6'] : '' }}" class="form-control txtKeywordEdit" name="txtKeywordEdit" placeholder="" required/>
