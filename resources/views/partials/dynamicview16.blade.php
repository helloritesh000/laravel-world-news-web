<h5>
    <a class="heading_tag" href="{{ route('list') }}/?q={{$keywordsXml['dynamicview16']}}">
        <span>{{ !empty($keywordsXml) ? $keywordsXml['dynamicview16'] : '' }}</span>
    </a>
    <div class="input-group" style="display: none;">
        <input type="hidden" class="hdnKeywordName" value="dynamicview16" />
    <input type="text" value="{{ !empty($keywordsXml) ? $keywordsXml['dynamicview16'] : '' }}" class="form-control txtKeywordEdit" name="txtKeywordEdit" placeholder="" required/>
