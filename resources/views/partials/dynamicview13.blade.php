<h5>
    <a class="heading_tag" href="{{ route('list') }}/?q={{$keywordsXml['dynamicview13']}}">
        <span>{{ !empty($keywordsXml) ? $keywordsXml['dynamicview13'] : '' }}</span>
    </a>
    <div class="input-group" style="display: none;">
        <input type="hidden" class="hdnKeywordName" value="dynamicview13" />
    <input type="text" value="{{ !empty($keywordsXml) ? $keywordsXml['dynamicview13'] : '' }}" class="form-control txtKeywordEdit" name="txtKeywordEdit" placeholder="" required/>
...
<a href="#"><img src="{{ asset('img/49.jpg') }}" width="100%"></a>
<ul style="max-height: 165px;">
    @if(!empty($newsList))
